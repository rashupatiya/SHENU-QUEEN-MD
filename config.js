...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("94762021150,")
...
global.sudo = process.env.SUDO || '94762021150'
global.devs = '94762021150';
...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME === undefined ? 'RASHU MUSIC' : process.env.OWNER_NAME,
  ownernumber: process.env.OWNER_NUMBER === undefined ? '94762021150' : process.env.OWNER_NUMBER,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? '🚨🧚‍♀️𝘙𝘈𝘚𝘏𝘜 𝘘𝘜𝘌𝘌𝘕:𝘙𝘈𝘚𝘏𝘜 𝘔𝘜𝘚𝘐𝘊' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? true : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? '𝗥𝗔𝗦𝗛𝗨 𝗤𝗨𝗘𝗘𝗡 𝗠𝗗' : process.env.PACK_INFO.split(";")[1],	
